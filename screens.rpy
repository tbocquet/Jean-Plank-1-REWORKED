...
screen navigation():
    ...
    vbox:
        ...
        textbutton _("Musiques") action ShowMenu("about")

        if renpy.variant("pc"):

            ## L'aide n’est ni nécessaire ni pertinente sur les appareils
            ## mobiles.
            textbutton _("English Version") action ShowMenu("help")
...
screen about():
    ...
    use game_menu(_("Musiques"), scroll="viewport"):
...
screen help():
    ...
    use game_menu(_("English Version"), scroll="viewport"):

        text _("An English version of the game can be found {a=https://jeanplank.blbl.ch/}here{/a} by clicking the \"EN\" in the drop menu upper right of the screen.\n\nAs a non-native speaker, some of the jokes may be hard to translate for me, especially the ones involving French internet culture. If you want to propose a better translation of a joke, I would gladly appreciate it.")
